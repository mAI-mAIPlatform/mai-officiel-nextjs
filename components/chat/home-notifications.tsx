...
export function HomeNotifications() {
  ...
  return (
    <div
      className="fixed top-3 left-1/2 z-30 flex -translate-x-1/2 flex-col items-center"
      ref={containerRef}
    >
      <button
      ...
      {isOpen && (
        <div className="liquid-glass absolute top-12 mt-2 w-[320px] rounded-2xl border border-border/50 bg-card/80 p-3 shadow-[var(--shadow-float)] backdrop-blur-xl">
