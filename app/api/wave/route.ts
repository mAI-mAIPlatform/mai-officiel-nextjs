...
export async function POST(request: Request) {
  ...
  const payload = {
    ...
    model: body.model,
    callBackUrl: process.env.SUNO_CALLBACK_URL || undefined,
    prompt,
    style: asTrimmedString(body.style) || undefined,
    title: asTrimmedString(body.title) || undefined,
    personaId: process.env.SUNO_PERSONA_ID || undefined,
    personaModel: process.env.SUNO_PERSONA_MODEL || "style_persona",
